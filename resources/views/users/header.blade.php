                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
                            ...
                            <div class="user_icon m-10">
                            <img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918647/user.svg" alt=""></div>
                            <div class="use m-10 ">
                            <div class=""><a style="color: #a19a9a;" href="{{ route('signup') }}">Register</a></div></div>
                            <div style="margin:18px; ">
                               <a style="color: #a19a9a;" href="{{ route('signin') }}">Sign in</a>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col ">
                            ...
                            <div class="main_nav_content d-flex flex-row h-50 ">
