...
<body class="hold-transition sidebar-mini" style="padding-top: 0;">
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('welcomehome') }}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4"
            style="background-color: #2b2a29; position:web-stiky; ">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
                ...
                <!-- Sidebar Menu -->
                @include('users.layout.uleftmenu')
                <!-- /.sidebar-menu -->
            </div>
            <!-- /.sidebar -->
        </aside>
