                            ...
                            <form method="POST" action="{{route('update.address')}}">
                                ...
                                <div class="media" style="padding: 30px;">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="mb-3">
                                            <span class="mr-2 d-block d-sm-inline-block mb-2 mb-sm-0" style="font-weight: bold;">City:</span>
                                            <span id="city" class="bg-light-blue">{{ $adress->city }}</span>
                                            <input id="cityInput" name="city" type="text" class="edit-mode" style="display: none; border: none;" value="{{ $adress->city }}">
                                        </div>
                                        <div class="mb-3">
                                            <span class="mr-2 d-block d-sm-inline-block mb-2 mb-sm-0" style="font-weight: bold;">Street:</span>
                                            <span id="street" class="bg-light-blue">{{ $adress->street }}</span>
                                            <input id="streetInput" name="street" type="text" class="edit-mode" style="display: none; border: 1px solid transparent;" value="{{ $adress->street }}">
                                        </div>
                                        <div class="mb-3">
                                            <span class="mr-2 d-block d-sm-inline-block mb-2 mb-sm-0" style="font-weight: bold;">Pincode:</span>
                                            <span id="pincode" class="bg-light-blue">{{ $adress->pincode }}</span>
                                            <input id="pincodeInput" name="pincode" type="text" class="edit-mode" style="display: none; border: 1px solid transparent;" value="{{ $adress->pincode }}">
                                        </div>
                                        <div class="mb-5">
                                            <span class="mr-2 d-block d-sm-inline-block mb-1 mb-sm-0" style="font-weight: bold;">Contact:</span>
                                ...
                                <div class="buttons-to-right">
                                    ...
                                    <button type="submit" class="btn-gray mr-2 updateButton" style="display: none; border:none;"><i class="far fa-check-circle mr-2"></i> Update</button>
                                    <button type="button" class="btn-gray mr-2 editButton" style="border: none;"><i class="fas fa-edit mr-2"></i> Edit address</button>
